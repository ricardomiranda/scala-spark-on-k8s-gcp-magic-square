...
//import com.ricardomiranda.magicsquare.CoreFunctions
...
object MagicSquareJsonSupport extends DefaultJsonProtocol with StrictLogging {
  ...
  implicit val MagicSquareConfigurationFormat: RootJsonFormat[MagicSquareConfiguration] = 
    jsonFormat9(MagicSquareConfiguration)

  case class MagicSquareConfiguration(crossoverRate: Double,
                                      elite: Int,
                                      iter: Int,
                                      mutationRate: Double,
                                      output: Int,
  ...
  /** Method to convert the contents of a configuration file into an object of type MagicSquareConfiguration
   *
   ...
   */
  def magicSquareConfigFileContentsToObject(configurationFilePath: String): MagicSquareConfiguration = {
